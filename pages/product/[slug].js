  ...
  return (
    <>
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-24 md:py-16 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex ">
                ...
                <button  onClick={()=>{addToCart(slug,1,580,'wear the trend(XL,RED','XL',"red")}} className="flex ml-8 text-white bg-pink-500 border-0 px-2 py-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">
                 Add To Cart
                </button>
              ...
              <div className="pin mt-6 flex space-x-2 text-sm">
                ...
                <button onClick={checkPinCode} className=" text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">Check Pincode</button>
              </div>
              {(!service && service !=null) &&
       <div className="text-red-700 text-sm mt-3 ">SORRY! We do not deliver to this pincode</div>}
          {( service && service !=null) && <div className="text-green-700 text-sm mt-3 ">Hurry! this pincode is serviceable</div>}
