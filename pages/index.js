...
export default function Home() {
  return (
    <div className=' text-pink-500 bg-blue-100'>
    <>
      <Head>
        <title>wear the Trend</title>
        <meta name="description" content="Ninja's wear.com " />
...
<div> 
  <Image src='/mens.jpeg' alt='mens pics carring a leather bag' width={1300} height={40}/>
</div>
<section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Wear The Trend</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">When you want to go with the trend ,wear the Trend</p>
    </div>
    <div className="flex flex-wrap -m-4">
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-gray-200 p-6 rounded-lg">
          <div className="w-10 h-10 inline-flex items-center justify-center rounded-full text-pink-500 bg-pink-100 mb-4">
